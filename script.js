...
const i18n = {
    pt: {
        ...
        'fs-desc': 'Set de exemplo para curadoria na Sixx House, uma das principais referências do Minimal Bass no Brasil. Pressão de pista do começo ao fim.',
        'fs-listen': 'Ouvir no SoundCloud',
        'aether-recorded'    : 'GRAVADO',
        'aether-tag'         : 'DESTAQUE',
        'aether-title1'      : 'APRESENTAÇÃO',
        'aether-subtitle'    : 'Itajaí - SC · 2026',
        ...
        'sixxvid-subtitle'   : 'São José - SC · 2026',
        ...
        'aftermov-sixx-sub'  : 'São José - SC · abertura',
        'drops-tag'          : 'DROPS',
    ...
    en: {
        ...
        'fs-title1': 'CURATION',
        'fs-subtitle': 'Minimal Bass &middot; 2026',
        'fs-desc': 'Example set for Sixx House curatorial booking — a key Minimal Bass reference in Brazil. Dance floor pressure from start to finish.',
        ...
        'aftermov-grand-sub' : 'Itajaí · Aether',
        'aftermov-sixx-title': 'Sixx House',
        'aftermov-sixx-sub'  : 'São José - SC · opening',
        'drops-tag'          : 'DROPS',
    ...
    es: {
        ...
        'fs-title1': 'CURADURÍA',
        'fs-subtitle': 'Minimal Bass &middot; 2026',
        'fs-desc': 'Set de ejemplo para curaduría en Sixx House, una de las principales referencias del Minimal Bass en Brasil. Presión de pista de principio a fin.',
        ...
        'aftermov-grand-sub' : 'Itajaí · Aether',
        'aftermov-sixx-title': 'Sixx House',
        'aftermov-sixx-sub'  : 'São José - SC · apertura',
        'drops-tag'          : 'DROPS',
    ...
    zh: {
        ...
        'fs-title1': '策展',
        'fs-subtitle': 'Minimal Bass &middot; 2026',
        'fs-desc': 'Sixx House 预订／策展用示例 Set，巴西 Minimal Bass 重要标杆之一。从头到尾的舞池张力。',
        ...
        'aftermov-grand-sub' : 'Itajaí · Aether',
        'aftermov-sixx-title': 'Sixx House',
        'aftermov-sixx-sub'  : 'São José - SC · 开场',
        'drops-tag'          : 'DROPS',
    ...
    de: {
        ...
        'fs-subtitle': 'Minimal Bass &middot; 2026',
        'fs-desc': 'Beispiel-Set für Booking/Kuratierung bei der Sixx House — eine der wichtigsten Minimal-Bass-Adressen in Brasilien. Dancefloor-Druck von Anfang bis Ende.',
    ...
    ja: {
        ...
        'fs-title1': 'キュレーション',
        'fs-subtitle': 'Minimal Bass &middot; 2026',
        'fs-desc': 'Sixx House のキュレーション／ブッキング用サンプルセット。ブラジル Minimal Bass の重要な拠点のひとつ。最初から最後までフロアを揺らす。',
        ...
        'aftermov-grand-sub' : 'Itajaí · Aether',
        'aftermov-sixx-title': 'Sixx House',
        'aftermov-sixx-sub'  : 'São José - SC · オープニング',
        'drops-tag'          : 'DROPS',
