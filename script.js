...
const i18n = {
    pt: {
        ...
        'tl-section-title'   : 'Uma trajetória profissional de <span class="text-glow">15 anos</span>',
        ...
        'drops-view-group-aria' : 'Modo de visualização dos drops',
        ...
        'fs-desc': 'Set de exemplo para curadoria na Sixx House, uma das principais referências atuais hoje do meu set.',
        'fs-listen': 'Ouvir no SoundCloud',
        'aether-recorded'    : 'GRAVADO',
        'aether-tag'         : 'DESTAQUE',
        'aether-title1'      : 'APRESENTAÇÃO',
        'aether-subtitle'    : 'Itajaí - SC',
        ...
        'sixxvid-subtitle'   : 'São José',
        'sixxvid-desc'       : 'Apresentação na Sixx House, uma das principais referências da cena eletrônica no Brasil. Set realizado após o Hotbullet tocar.',
        'sixxvid-cta'        : 'Assistir no YouTube',
        'aftermov-tag'       : 'AFTER MOVIE',
        'aftermov-title'     : 'After <span class="text-glow">movies</span>',
        'aftermov-desc'      : 'Aberturas e momentos dos rolês na The Grand e na Sixx House.',
        'aftermov-grand-title': 'Aether',
        'aftermov-grand-sub' : 'Itajaí - SC',
        'aftermov-sixx-title': 'Sixx House',
        'aftermov-sixx-sub'  : 'São José',
        'drops-tag'          : 'DROPS',
    ...
    en: {
        ...
        'tl-section-title'   : 'A professional journey of <span class="text-glow">15 years</span>',
        ...
        'lugares-title'      : 'Main venues where<br><span class="text-glow">I\'ve performed</span>',
        'lugares-view-carousel' : 'Carousel',
        'lugares-view-list'     : 'Full grid',
        'lugares-view-group-aria': 'Flyer view mode',
        'drops-view-group-aria' : 'Drops view mode',
        ...
        'fs-title1': 'CURATION',
        'fs-subtitle': 'Minimal Bass &middot; 2026',
        'fs-desc': 'Example set for curatorial booking at Sixx House — one of the main references for my sound right now.',
        ...
        'sixxvid-subtitle'   : 'São José',
        'sixxvid-desc'       : 'Performance at Sixx House, one of the main references in Brazil\'s electronic music scene. Set played after Hotbullet.',
    ...
    es: {
        ...
        'hero-presskit'      : 'Kit de prensa →',
        'stat-years'         : 'Años de Música',
        'badge-pressure'     : 'Presión de Pista',
        'tl-section-tag'     : 'LA HISTORIA',
        'tl-section-title'   : 'Una trayectoria profesional de <span class="text-glow">15 años</span>',
        ...
        'lugares-tag'        : 'ESCENARIO Y EVENTOS',
        ...
        'drops-view-group-aria' : 'Modo de vista de los drops',
        ...
        'fs-title1': 'CURADURÍA',
        'fs-subtitle': 'Minimal Bass &middot; 2026',
        'fs-desc': 'Set de ejemplo para curaduría en Sixx House, una de las principales referencias actuales de mi set.',
        ...
        'sixxvid-subtitle'   : 'São José',
        'sixxvid-desc'       : 'Presentación en Sixx House, una de las principales referencias de la escena electrónica en Brasil. Set después de Hotbullet.',
    ...
    zh: {
        ...
        'badge-pressure'     : '舞台张力',
        'tl-section-tag'     : '历程',
        'tl-section-title'   : '十五年的<span class="text-glow">专业历程</span>',
        ...
        'lugares-tag'        : '舞台与活动',
        'lugares-title'      : '我曾登台的主要场所<br><span class="text-glow">与演出经历</span>',
        'lugares-view-carousel' : '轮播',
        'lugares-view-list'     : '完整网格',
        'lugares-view-group-aria': '海报显示模式',
        'drops-view-group-aria' : 'Drops 显示模式',
        'tocando-tag'        : '现场演出',
        ...
        'fs-title1': '策展',
        'fs-subtitle': 'Minimal Bass &middot; 2026',
        'fs-desc': 'Sixx House 策展示例 Set，也是我当下 set 最重要的参考之一。',
        ...
        'sixxvid-title1'     : '现场演出',
        'sixxvid-subtitle'   : 'São José',
        'sixxvid-desc'       : 'Sixx House 现场，巴西电子音乐场景的重要标杆之一。在 Hotbullet 之后演出的 set。',
    ...
    de: {
        ...
        'hero-presskit'      : 'Pressemappe →',
        'stat-years'         : 'Jahre Musik',
        'badge-pressure'     : 'Floor-Druck',
        'tl-section-tag'     : 'DIE GESCHICHTE',
        'tl-section-title'   : 'Eine professionelle Laufbahn von <span class="text-glow">15 Jahren</span>',
        ...
        'lugares-title'      : 'Bühnen, auf denen ich<br><span class="text-glow">aufgetreten bin</span>',
        'lugares-view-carousel' : 'Karussell',
        'lugares-view-list'     : 'Raster',
        'lugares-view-group-aria': 'Flyer-Ansicht',
        'drops-view-group-aria' : 'Drops-Ansicht',
        ...
        'fs-tag': 'HIGHLIGHT',
        'fs-new': 'NEUES SET',
        'fs-title1': 'KURATIERUNG',
        'fs-subtitle': 'Minimal Bass &middot; 2026',
        'fs-desc': 'Beispiel-Set für Kuratierung bei der Sixx House — eine der wichtigsten aktuellen Referenzen für mein Set.',
        ...
        'sixxvid-subtitle'   : 'São José',
        'sixxvid-desc'       : 'Auftritt in der Sixx House, einer der wichtigsten Adressen für die elektronische Szene in Brasilien. Set nach Hotbullet.',
    ...
    ja: {
        ...
        'hero-listen'        : '今すぐ聴く',
        'hero-presskit'      : 'プレスキット →',
        'stat-years'         : '音楽歴（年）',
        'badge-pressure'     : 'フロアの圧力',
        'tl-section-tag'     : 'ヒストリー',
        'tl-section-title'   : 'プロとして<span class="text-glow">15年</span>の軌跡',
        ...
        'lugares-title'      : 'これまで出演した<br><span class="text-glow">主なステージ</span>',
        'lugares-view-carousel' : 'カルーセル',
        'lugares-view-list'     : '一覧グリッド',
        'lugares-view-group-aria': 'フライヤー表示モード',
        'drops-view-group-aria' : 'ドロップ表示モード',
        'tocando-tag'        : 'ライブ演奏',
        ...
        'fs-title1': 'キュレーション',
        'fs-subtitle': 'Minimal Bass &middot; 2026',
        'fs-desc': 'Sixx House のキュレーション用サンプルセット。今の自分のセットにおける重要な参照のひとつ。',
        ...
        'sixxvid-title1'     : 'ライブ',
        'sixxvid-subtitle'   : 'São José',
        'sixxvid-desc'       : 'Sixx House にて。ブラジルの電子音楽シーンを代表する会場のひとつ。Hotbullet の後のセット。',
